...
| Present Simple 10-stage game | CURRENT | Millionaire student-facing identity is `เกมพิชิต 10 ด่าน` with a display-only star ladder and explicit continue after feedback. Assessment stays 10 of 50, percentage scoring, 70/85 bands, and Sprint 41 Result routing. Quiz keeps the shared `.millionaire*` styles. |
